...
class MapCreator {
    ...
    MapCreator(ImageLoader imageLoader) {
        ...
        BufferedImage sprite = imageLoader.loadImage("/sprite" + path);
        ...
        this.goombaLeft = imageLoader.getSubImage(sprite, 2, 3, 48, 90);
        this.goombaRight = imageLoader.getSubImage(sprite, 5, 3, 48, 90);
        this.koopaLeft = imageLoader.getSubImage(sprite, 1, 3, 48, 90);
        this.koopaRight = imageLoader.getSubImage(sprite, 4, 3, 48, 90);
